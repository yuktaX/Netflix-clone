        ...
        <div className='w-full h-full text-white'>
            <div className='w-full h-[600px]'>
                ...
                <div className='absolute w-full top-[20%] p-4 md:p-8 '>
                    <h1 className='text-3xl md:text-5xl lg:text-7xl font-bold flex items-center'>{movie?.title  || movie?.name || movie?.original_name}</h1>
                    ...
                    <p className='w-full md:max-w-[70%] lg:max-w-[50%] xl:max-w-[35%] text-gray-200'>
                        ...
                        <div className='flex space-x-3 my-4'>
                            ...
                            <button className='heroButton bg-[gray]/70'>  
                                < HiInformationCircle className='h-4 w-4 md:h-7 md:w-7' />More Info
                            </button>
                        </div>
                </div>
            </div>
            {trailerURL && <YouTube videoId={trailerURL} opts={opts} className='z-30'/>}
        </div>
    )
