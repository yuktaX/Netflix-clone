    ...
    return (
        <nav className={scrolled && 'bg-[#141414] bg-gradient-to-br from-black'}>
            ...
            <div className='flex space-x-2 justify-end p-4 z-[100] w-full relative'>
                <Link to='/login'>
                <button className='text-white py-1 px-6 rounded hover:bg-slate-200/20 flex space-x-2'>Sign In</button>
                </Link>
                <Link to='/signup'>
                <button className='bg-red-600 text-white py-1 px-6 rounded hover:opacity-60'>Sign Up</button>
                </Link>
            </div>
        </nav>
